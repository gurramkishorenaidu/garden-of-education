                  ...
                  <dl className="mt-8 space-y-6">
                    ...
                    <dd className="flex text-base text-teal-50">
                      <PhoneIcon
                        ...
                        aria-hidden="true"
                      />
                      <span className="ml-3">+91 999-999-999-9</span>
                    </dd>
                    <dt>
                    ...
                    <dd className="flex text-base text-teal-50">
                      {/* <MailIcon
                        ...
                        aria-hidden="true"
                      /> */}
                      <span className="ml-3">support@gardenofeducation.com</span>
                    </dd>
                  </dl>
                ...
                <div className="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                  ...
                  >
                    <div>
                      ...
                      <div className="mt-1">
                        <input
                          ...
                          className="py-2 px-4 block w-full shadow-sm text-warm-gray-900 focus:ring-teal-500 focus:border-teal-500 border-warm-gray-300 rounded-md"
                        />
                      </div>
                    </div>
                    <div>
                    ...
                    <div className="sm:col-span-2">
                      ...
                      <div className="mt-1">
                        <textarea
                          ...
                          name="message"
                          rows={4}
                          className="py-2 px-4 block w-full shadow-sm text-warm-gray-900 focus:ring-teal-500 focus:border-teal-500 border border-warm-gray-300 rounded-md"
                    ...
                    <div className="sm:col-span-2 sm:flex sm:justify-end">
                      <button
                        type="submit"
                        className="mt-2 w-full inline-flex items-center justify-center px-6 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-teal-500 hover:bg-teal-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 sm:w-auto"
                      >
                        Submit
                      </button>
                    </div>
